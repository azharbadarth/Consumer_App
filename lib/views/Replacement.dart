  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
              ...
              child: Padding(padding: EdgeInsets.only(top: 30,left: 20),
        ...
        const  Padding(
            ...
            child:    Text("Replacement Shipment Types",style: TextStyle(fontSize: 16),),
          ),
                ...
                child: Container(
                    ...
                    const    Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                            height: 39,
                            child: Image(image: AssetImage("assets/circle_icon.png"))),
                            SizedBox(width: 4,),
                            SizedBox(
                            height: 39,
                      ...
                      const  SizedBox(height: 4,),
                        Container(
                          height: 39,
                          width: 130,
                          child: const Text("Replace BlueEX shipment",maxLines: 2,textAlign: TextAlign.center,)),
                      ],),
                   ),
              ),
      ...
      // second container
                    ...
                    const  SizedBox(height: 37,),
                      ...
                      Row(
                        ...
                        SizedBox(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const customer_detailview()));
                            },
                            child: const Image(image: AssetImage("assets/circle_icon.png")))),
                      const  SizedBox(width: 4,),
                      const  SizedBox(
                         height: 39,
                          child: Image(image: AssetImage("assets/3PL.png"))),
                      ],),
        ...
        child: CustomTextField(hinttext: "Enter Master Shipment Number:",Color: ColorSelect().text5),
        ),
        ...
        child: Container(
          ...
          child: CustomElevated(txt: "Submit Master CN",bgcolor: ColorSelect().splashcolor,onPressed: (){
    ...
    if(data == true) 
            ...
            child: Text.rich(TextSpan(
                   text: "Note: ",
                          style:  TextStyle(
                          color: ColorSelect().blackcolor, fontSize: 16,height: 1.2),
                          children: <InlineSpan>[
                          TextSpan(
                          text: "Please enter the delivered shipment number in the above text field.",
                          style: TextStyle(
